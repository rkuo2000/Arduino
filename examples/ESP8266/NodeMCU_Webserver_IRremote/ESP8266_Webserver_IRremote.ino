...
const String HTTP_STYLE  = "<style>.c{text-align: center;} div,input{padding:5px;font-size:1em;}  input{width:90%;}  body{text-align: center;font-family:verdana;} button{border:0;border-radius:0.6rem;background-color:#3b5998;color:#dfe3ee;line-height:2.4rem;font-size:1.2rem;width:100%;} .q{float: right;width: 64px;text-align: right;} .buttonboxon {background-color: #dfe3ee; color:#3b5998} .buttonsmod {background-color: #8b9dc3; color:#DB4437} .buttonokup {background-color: #8b9dc3; color:#dfe3ee} .buttonml {background-color: #8b9dc3; color:#DB4437} .buttonokdn {background-color: #8b9dc3; color:#dfe3ee} .buttonoklt {background-color: #8b9dc3; color:#dfe3ee} .buttonokrt {background-color: #8b9dc3; color:#dfe3ee} .buttonok {background-color: #8b9dc3; color:#dfe3ee}  .buttonexit {background-color: #8b9dc3; color:#3b5998} .buttonreturn {background-color: #8b9dc3; color:#3b5998} } </style>";
...
const String TABLE_ROW6 = "<tr><td><form action=\"/cmdsmod\" method=\"get\"><button style=\"width: 80px; height: 40px; font-size: 15px\" class=\"buttonsmod\">SMOD</button></form></td><td><form action=\"/cmdokup\" method=\"get\"><button style=\"width: 80px; height: 40px; font-size: 15px\" class=\"buttonokup\"> up </button></form></td><td><form action=\"/cmdml\" method=\"get\"><button style=\"width: 80px; height: 40px; font-size: 15px\" class=\"buttonml\">ML</button></form></td></tr>";
...
// Code data captured by IRrecvDumpV2.ino (IRremoteESP8266 library)
...
uint16_t ML_a[35] = {172, 962,  152, 2316,  152, 824,  152, 2858,  150, 1368,  150, 1368,  150, 1504,  152, 1906,  150, 14308,  156, 938,  170, 2178,  152, 806,  170, 804,  172, 1502,  152, 824,  152, 822,  152, 822,  150};  // UNKNOWN 2CC6AFED
uint16_t ML_b[35] = {152, 964,  152, 2316,  152, 802,  172, 2858,  152, 1368,  150, 1366,  152, 1502,  150, 1912,  150, 14310,  152, 940,  170, 1096,  152, 1908,  152, 822,  152, 1502,  152, 824,  148, 806,  170, 824,  152};  // UNKNOWN D1791971
...
void cmdml() {
  server.send(200, "text/html", HOMEPAGE);
  irsend.sendRaw(ML_a, 35, 38);  // Send a raw data capture at 38kHz.  
  irsend.sendRaw(ML_b, 35, 38);  // Send a raw data capture at 38kHz.
}
