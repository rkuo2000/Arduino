...
void loop() {
  ...
  // to upload data to a Google sheet
  String url = "https://script.google.com/macros/s/AKfycbw5GqjBWKd_6hYv29kL94p1Sh7TPNdWMJQ5fD9EHVkD9ER7yTvZ/exec?";
  url += "A=";          // colume 1 is Temp.
  url += String(temp);
  url += "&B=";
  url += String(humid); // colume 2 is Humidity
