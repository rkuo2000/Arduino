;l// Playing a digital WAV recording repeatadly using the XTronical DAC Audio library
...
// Modification to support SRAM reduction by using const unsigned char *WavData
// XT_DAC_Audio.cpp : XT_Wav_Class::XT_Wav_Class(const unsigned char *WavData)
// XT_DAC_Audio.h   : XT_Wav_Class(const unsigned char *WavData);

#include "SoundData.h";
#include "XT_DAC_Audio.h";

XT_Wav_Class ForceWithYou(SoundData); // create an object of type XT_Wav_Class that is used by 
