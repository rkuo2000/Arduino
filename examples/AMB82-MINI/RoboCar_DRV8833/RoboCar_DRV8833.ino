...
#define IN1_PIN     7 // in1 pin from one of the two DRV8833 H-bridge
#define IN2_PIN     8 // in2 pin from one of the two DRV8833 H-bridge
#define CHANNEL     0 // there are 16 unique PWM channels (0..15)
#define SWAP    false // swap motor rotation direction

drv8833 myMotor; // default constructor
