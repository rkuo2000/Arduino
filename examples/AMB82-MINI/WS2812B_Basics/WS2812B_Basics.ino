...
void setup() {
    ...
    led.setPixelColor(2, 0, 50, 0);
    led.setPixelColor(3, 0, 50, 0);
    led.setPixelColor(4, 0, 50, 0);
    led.setPixelColor(5, 0, 50, 0);
    led.setPixelColor(6, 0, 50, 0);
    led.setPixelColor(7, 0, 50, 0);
    led.show();
    delay(1000);
