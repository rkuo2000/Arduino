...
const String HTTP_HEAD   = "<!DOCTYPE html><html lang=\"en\"><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=no\"/><title>Kbro Remote</title>";
...
const String HOMEPAGE = HTTP_HEAD + HTTP_STYLE + HTTP_HEAD_END + BODY_TABLE + TABLE_ROW0 + TABLE_ROW1 + TABLE_ROW2 + TABLE_ROW3 + TABLE_ROW4 + TABLE_ROW5 + TABLE_ROW6 + TABLE_ROW7 + TABLE_ROW8 + BODY_END;
