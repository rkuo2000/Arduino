...
#define blinkPin D0 // for NodeMCU
...
//    digitalWrite(blinkPin, blinkOn);
      ...
      Serial.print(","); Serial.print(gz,4);
      
      Serial.print(","); Serial.print(mx,4); 
      Serial.print(","); Serial.print(my,4); 
      Serial.print(","); Serial.print(mz,4);
